...
<details>
<summary> <strong> 🎧 Vibing to & Coding: </strong> </summary>
<br>
...
[![telegram badge](https://img.shields.io/badge/Telegram-Contact-grey?style=flat&logo=telegram)](https://t.me/YOUR_TELEGRAM) <br>
</div>
...
class About extends Me { 
  const myTools = {  
    "WebDev" : { "HTML", "CSS", "JavaScript", "PHP", "Python" },
    "Security" : { "Linux", "Bash", "Python", "Networking" },
    "Database" : { "MySQL", "PostgreSQL", "Firebase" },
    "Editors" : { "Vscode", "Neovim", "Sublime" },
    "Platforms" : { "Windows", "Ubuntu", "Kali Linux" },
    "Hobbies" : { "Gaming", "CTF", "Pentesting" }
  };
}
